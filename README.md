...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4475&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlalchemy-redshift-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlalchemy-redshift` can be installed with `conda`:
...
```
mamba install sqlalchemy-redshift
```

It is possible to list all of the versions of `sqlalchemy-redshift` available on your platform with `conda`:
...
```
mamba search sqlalchemy-redshift --channel conda-forge
```
...
mamba repoquery search sqlalchemy-redshift --channel conda-forge

# List packages depending on `sqlalchemy-redshift`:
mamba repoquery whoneeds sqlalchemy-redshift --channel conda-forge

# List dependencies of `sqlalchemy-redshift`:
mamba repoquery depends sqlalchemy-redshift --channel conda-forge
```
